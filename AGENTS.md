...
## حالة البناء
- **المرحلة 1 (الأساس) مكتملة**: السقالة + RBAC/تنقّل/طبقات أفقية + مخطّط (الأساس + نواة الخدمات) + لوحة + صفحات مؤقتة. بناء أخضر.
- التالي: 2) المختبر · 3) السوق · 4) الصيانة · 5) الطبقات المساندة · 6) الأدمن واللوحات.
